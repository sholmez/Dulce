...
$query = "SELECT * FROM dishes WHERE type = 'drinks'";
        ...
        <div class="container">
          <div class="breadcrumbs-custom__inner">
            <ul class="breadcrumbs-custom__path">
              ...
              <li class="active">Напої</li>
            </ul>
          </div>
        </div>
      </section>
      <section class="text-center">
        <section class="section parallax-container" data-parallax-img="images/parallax-09.jpg">
                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            <div class="thumb thumb-corporate">
                                <div class="thumb-corporate__main">
                                    <img src="images/<?php echo $drink['image']; ?>" alt="<?php echo $drink['name']; ?>" width="418" height="315"/>
                                </div>
                                <div class="thumb-corporate__caption">
                                    <p class="thumb__title">
                                        <a href="single-product.php?id=<?php echo $drink['id']; ?>"><?php echo $drink['name']; ?></a>
                                    </p>
                                    <p class="thumb__subtitle">₴<?php echo $drink['price']; ?></p>
                                    <p><?php echo $drink['composition']; ?></p>
                                    <p><?php echo $drink['size']; ?>гр</p>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
                <?php else: ?>
                    <p>Нажаль наразі немає напоїв для показу.</p>
                <?php endif; ?>
            </div>
        </div>
    </section>
