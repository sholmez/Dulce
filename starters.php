...
$query = "SELECT * FROM dishes WHERE type = 'starter_dish'";
        ...
        <div class="container">
          <div class="breadcrumbs-custom__inner">
            <ul class="breadcrumbs-custom__path">
              ...
              <li class="active">Закуски</li>
            </ul>
          </div>
        </div>
      </section>
      <section class="text-center">
        <section class="section parallax-container" data-parallax-img="images/parallax-06.jpg">
                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            <div class="thumb thumb-corporate">
                                <div class="thumb-corporate__main">
                                    <img src="images/<?php echo $starter['image']; ?>" alt="<?php echo $starter['name']; ?>" width="418" height="315"/>
                                </div>
                                <div class="thumb-corporate__caption">
                                    <p class="thumb__title">
                                        <a href="single-product.php?id=<?php echo $starter['id']; ?>"><?php echo $starter['name']; ?></a>
                                    </p>
                                    <p class="thumb__subtitle">₴<?php echo $starter['price']; ?></p>
                                    <p><?php echo $starter['composition']; ?></p>
                                    <p><?php echo $starter['size']; ?>гр</p>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
